            ...
            <div className="nav-links mt-2 flex-grow-1">
                {items.map((item) => (
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `nav-item py-2 px-2 rounded d-flex align-items-center text-decoration-none ${isActive ? "bg-light text-dark fw-bold" : "text-white"
                            }`
                        }
                        style={{
                            marginBottom: "14px",
                        ...
                        onMouseEnter={(e) => {
                            if (!e.target.closest('a').classList.contains('text-dark')) {
